    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-base)', padding: '2rem' }}>
        <form onSubmit={handleSubmit}>
          ...
          {/* Invoice Code — auto-generated by trg_invoices_auto_code, not entered here */}
          <div style={field}>
            ...
            <div style={{
              ...
              VNS0…: IN-V(ngày)…p- {form.template_type}
            </div>
            <div style={{ fontSize: 'var(--text-xs)', color: 'var(--text-muted)', marginTop: 4 }}>
              Tự sinh sau khi tạo — số thứ tự, ngày tạo, số item, template. Số item tự cập nhật
              khi bạn thêm/xoá item. Sửa tay được ở trang chi tiết nếu cần.
            </div>
          </div>
